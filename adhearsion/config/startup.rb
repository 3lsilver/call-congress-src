...
require "#{File.dirname(File.expand_path(__FILE__))}/../../lib/models/call"
require "#{File.dirname(File.expand_path(__FILE__))}/../../lib/models/legislator"
require "#{File.dirname(File.expand_path(__FILE__))}/../../lib/models/phone"
...
SiteConfig = OpenStruct.new(YAML.load_file("#{File.dirname(File.expand_path(__FILE__))}/../../settings.yaml"))
puts SiteConfig.inspect
...
Adhearsion::Configuration.configure do |config|
  ...
  config.asterisk.enable_ami :host => SiteConfig.ami_host, :username => SiteConfig.ami_user, :password => SiteConfig.ami_pass, :events => true
  
  config.enable_drb :port => SiteConfig.drb_port
